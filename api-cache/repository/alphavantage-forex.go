...
// func NewAlphaVantageForexRepository(apiKey string, tsdbClient tsdb.TSDBClient) ForexRepository {
...
// func (r *AlphaVantageStockRepository) HandleForexRequests() {
// 	for {
...
// func (r *AlphaVantageStockRepository) handleIntradayRequest(req model.AlphaVantageRequest) error {
...
// func (r *AlphaVantageStockRepository) handlePeriodicRequest(req model.AlphaVantageRequest) error {
